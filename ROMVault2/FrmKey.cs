            ...
            for (int i = 0; i < displayList.Count; i++)
            {
                ...
                switch (displayList[i])
                {
                    ...
                    case RepStatus.InUnsorted:
                        text = "Magenta - This ROM is in the Unsorted directory, after Finding Fixes this ROM is not needed in any sets.";
                        break;
                    ...
                    case RepStatus.MoveUnsorted:
                        text = "Purple - This ROM is not found in any DAT set, and so will be moved out to Unsorted.";
                        break;
